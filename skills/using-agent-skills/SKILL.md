...
Task arrives
    ...
    │   ├── UI visual direction unresolved? → get-design
    │   ├── Established UI implementation? ─→ frontend-ui-engineering
...
| Build | get-design | Product-specific visual direction, anti-AI-slop design, critique, and UI refinement |
